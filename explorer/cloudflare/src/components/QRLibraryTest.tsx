...
interface QRLibraryTestProps {
  onClose: () => void;
}

type TestStatus = 'idle' | 'starting' | 'scanning' | 'detected' | 'error';
...
export const QRLibraryTest: React.FC<QRLibraryTestProps> = ({ onClose }) => {
    ...
    <div className="camera-test">
      ...
      <div className="camera-test-info">
        <div className="camera-test-status-row">
          <span className="camera-test-label">デコーダ:</span>
          <span className="camera-test-value camera-test-status-success">
            jsQR (v1.4.0)
          </span>
        </div>
